...
//  Conjugation
//
//  Created by Wasim Sandhu on 6/19/16.
...
class LearnViewController: UIViewController, UITextViewDelegate {
    ...
    func changeText(_ textView: UITextView) {
    
    if (tense != nil) {
        if (tense! == "Present Tense") {
            textView.text = "The present tense is used to describe an action that is happening now.\n" +
            "\n" +
                ...
                "• tener\n" +
            "• caer"
        } else if (tense == "Preterite Tense") {
            text.text = "The preterite tense is used to describe things that happened in the past. It tells what happened at a particular moment in the past.\n" +
                "\n" +
                ...
                "• ver\n" +
            "• dar"
        } else if (tense == "Imperfect Tense") {
            text.text = "The imperfect tense is used to describe something that was not completed in the past. Simple past tense like \"I walked\" would become \"I was walking\" or \"I used to walk\".\n" +
                "\n" +
            ...
            text.text = "The future tense is used to describe actions that will happen in the future. For example, \"I dance\" to \"I will dance\".\n" +
                "\n" +
                ...
                "• decir → dir-\n" +
            "• hacer → har-"
        } else if (tense == "Imperative Tense") {
            text.text = "The imperative tense is used to tell someone to do or not to do something, respectfully or directly. It has three parts: tú commands, nosotros commands, and usted/ustedes commands.\n" +
                "\n" +
                ...
                "• saber → sepa/sepan\n" +
            "• ser → sea/sean"
        } else if (tense == "Negative Imperative Tense") {
            text.text = "The imperative tense is used to tell someone to do or not to do something, respectfully or directly. It has three parts: tú commands, nosotros commands, and usted/ustedes commands.\n" +
                "\n" +
                "Tú commands are used to give commands to someone you know well. Regular AFFIRMATIVE TÚ COMMANDS are the same as the él/ella/usted form of a verb in the present tense. To form this command, remove the ending and add the present tense él/ella/usted ending.\n" +
                "\n" +
                ...
                "• saber → sepa/sepan\n" +
            "• ser → sea/sean"
        } else if (tense == "Present Subjunctive Tense") {
            text.text = "The present subjunctive is used to describe emotions of doubt, hope, or other emotion in a subjective manner. For example, \"Es importante que ella aprenda español.\"\n" +
                "\n" +
                ...
                "• ser\n" +
            "• haber"
        } else if (tense == "Imperfect Subjunctive Tense") {
            text.text = "The imperfect subjunctive is used to describe expressions of hope, doubt, emotion or opinion in the past.\n" +
                "\n" +
                ...
                "2. durmie-\n" +
            "3. durmieras"
        } else if (tense == "Conditional Tense") {
            text.text = "The conditional tense is used to describe what someone would or wouldn't do.\n" +
                "\n" +
                ...
                "• decir → dir-\n" +
            "• hacer → har-"
        } else if (tense! == "Present Perfect Tense") {
            text.text = "The present perfect tense is used to describe events that have already happened.\n" +
                "\n" +
        ...
        } else if (tense! == "Past Perfect Tense") {
            text.text = "The past perfect tense is used to describe events that had already occurred.\n" +
                "\n" +
        ...
        } else if (tense! == "Future Perfect Tense") {
            text.text = "The future perfect tense is used to describe what will have happened at a certain point in the future.\n" +
                "\n" +
            ...
            text.text = "To form the present perfect subjunctive tense, follow these steps:\n" +
            "\n" +
        ...
        } else if (tense! == "Past Perfect Subjunctive") {
            text.text = "To form the past perfect subjunctive tense, follow these steps:\n" +
            "\n" +
        ...
        } else if (tense! == "Conditional Perfect Tense") {
            text.text = "To form the conditional perfect subjunctive tense, follow these steps:\n" +
                "\n" +
                "1. Conjugate the verb \"haber\" in the conditional tense\n" +
                "2. Add the past participle of the main verb\n" +
                "\n" +
                "Basically, conditional tense \"haber\" plus past participle.\n" +
                "\n" +
                "Conjugations of \"haber\":\n" +
                "• Yo habría\n" +
                "• Tú habrías\n" +
                ...
                "\n" +
            "For example, to conjugate \"dormir\" to the Yo form: \"Yo habría dormido\"."
        }
    } else {
        textView.text = "The present tense is used to describe an action that is happening now.\n" +
            "\n" +
